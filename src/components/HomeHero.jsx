    ...
    <div className="hero min-h-screen bg-base-200 w-full">
      <div className="hero-content text-center w-full">
        <div className="max-w-full mx-auto">
          ...
          <a className="btn btn-primary" href='https://docs.google.com/document/d/1BihOwOeDVsYWpfUOpa2GJQ555Tdubr-XzQC--uZtKgU/edit?usp=sharing' target='_blank' rel='noopener noreferrer'>View my resume</a>
